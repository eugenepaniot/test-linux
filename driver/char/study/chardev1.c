...
static int __init mycdev_init(void)
{
	...
	printk("chardev1 module is staring..\n");

	ret=register_chrdev(MYCDEV_MAJOR,"chardev1", &mycdev_fops);
	if(ret<0)
	{
...
{
	printk("chardev1 module is leaving..\n");
	unregister_chrdev(MYCDEV_MAJOR, "chardev1");
}
