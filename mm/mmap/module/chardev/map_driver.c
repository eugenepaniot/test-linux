...
{  
    ...
    * (unsigned long)vmalloc_area,
    * (unsigned long)vmalloc_to_pfn((void *)vmalloc_area) << PAGE_SHIFT);  */
...
{  
    ...
    virt_start = (unsigned long)vmalloc_area + 
                 (unsigned long)(vmf->pgoff << PAGE_SHIFT);
